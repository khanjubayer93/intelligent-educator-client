            ...
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-50 text-gray-800">
                ...
                <form novalidate="" action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <label htmlFor="password" className="text-sm">Email</label>
                    ...
                    <button type="button" className="w-full px-8 py-3 font-semibold rounded-md bg-sky-600 text-gray-50">Sign Up</button>
                </form>
            </div>
        </div>
    );
