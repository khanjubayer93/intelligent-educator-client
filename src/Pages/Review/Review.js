...
const Review = () => {
    return (
        <div className="flex flex-col w-2/5 p-8 shadow-sm rounded-xl lg:p-12 bg-gray-50 text-gray-800">
            <div className="flex flex-col items-center w-full">
                ...
                <div className="flex flex-col w-full">
                    ...
                    <button type="button" className="py-4 my-8 font-semibold rounded-md text-gray-50 bg-sky-600">Leave feedback</button>
                </div>
            </div>
